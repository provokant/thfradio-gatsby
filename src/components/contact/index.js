  ...
  return (
    <div>
      ...
      <div className="contact">
        <div><ButtonExternal href="mailto:info@thfradio.de?subject=Anfragen zum THF Radio">THF Radio</ButtonExternal>
        </div>
      ...
      <div className="english">Interested in playing a one-off radio show or having a residency at THF Radio (or to join
        our community radio and Verein)?
      </div>
      <div className="contact">
        <div><ButtonExternal href="mailto:play@thfradio.de?subject=Show bei THF Radio">play @ thfradio</ButtonExternal>
        </div>
      </div>
    </div>
